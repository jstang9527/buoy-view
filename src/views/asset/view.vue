...
export default {
    ...
    data() {
        return {
            ...
            box1:{
                'title': 'AssetVendor', 'image': 'https://zan71.com/cdn-img/icon/avatar/tx.gif', 'type': 'pie',
                'series': [
            ...
            box2: {
                'title': 'SubDoamin', 'image': 'https://zan71.com/cdn-img/icon/avatar/tx.gif', 'type': 'pie',
                'series': [
            ...
            box3: {
                'title': 'Software', 'image': 'https://zan71.com/cdn-img/icon/avatar/tx1.gif', 'type': 'pie',
                'series': [
            ...
            box4: {
                'title': 'Vul Type', 'image': 'https://zan71.com/cdn-img/icon/avatar/tx.gif', 'type': 'pie',
                'series': [
            ...
            box5: {
                'title': 'Vulnerability', 'image': 'https://zan71.com/cdn-img/icon/avatar/tx.gif', 'type': 'table',
                'series': [
                    {
                        "id": 7, "asset_id": 55,
            ...
            box6:{
                'title': 'WebSite', 'image': 'https://zan71.com/cdn-img/icon/avatar/tx.gif', 'type': 'line',
                'series': [
            ...
            box6_bak:{
                'title': 'Penetration', 'image': 'https://zan71.com/cdn-img/icon/avatar/tx.gif', 'type': 'timeline',
                'series': [
    ...
    methods: {
        ...
        handlerWs: function () {
            if(typeof(WebSocket) === "undefined"){
                ...
                // 实例化socket
                let path = "ws://172.31.50.249:8700/task/stat" + "?id="+ this.task_id
